...
export const translations = {
  en: {
    ...
    dashboard: {
      ...
      tasksDoneSub: (total) => `of ${total} total`,
      highPriority: "High Priority",
      highPrioritySub: "needs immediate attention",
      streak: "Streak",
      ...
      pendingTasks: (n) => `${n} pending`,
      noTasks: "No tasks yet",
      targetProgress: "Target Progress",
      studyHoursTarget: "Study Hours",
      tasksDoneTarget: "Tasks Done",
    ...
    wrapped: {
      ...
      tagline: "Another month on the rise. 🔥",
      intro: (month) => `Here's your ${month} recap.`,
      bodyText: "What an amazing month!\nYou're getting more consistent and keep growing.",
      tasksDoneLabel: "Tasks done",
      focusTimeLabel: "Focus time",
      bestStreakLabel: "Best streak",
      closeBtn: "Close ✕",
      swipeHint: "Swipe or click card behind",
      tasksTag: "Tasks",
      focusTag: "Focus time",
      streakTag: "Streak",
      categoriesTag: "Top Categories",
      nextMonthTag: "Next Month",
      tasksDoneThisMonth: "done this month",
      totalFocusThisMonth: "total focus this month",
      avgPerDay: "Average 1.5 hrs per day",
      distribution: "Distribution",
      longestStreak: "longest streak",
      personalBest: "Personal best! Keep it up 💪",
      checkinThisMonth: "Check-in this month",
      mostProductiveIn: "You were most productive in ",
      nextMonthDesc: (tasks) => `If you keep this rhythm, next month you can achieve ${tasks} tasks.`,
      targetTasks: "Target tasks",
      targetStreak: "Target streak",
  ...
  id: {
    ...
    dashboard: {
      ...
      tasksDoneSub: (total) => `dari ${total} total`,
      highPriority: "Prioritas Tinggi",
      highPrioritySub: "perlu segera dikerjakan",
      streak: "Runtutan",
      streakSub: "hari berturut-turut",
      studyHours: "Jam Belajar",
      studyHoursSub: "hari ini",
      weeklyActivity: "Aktivitas Minggu Ini",
      studyHoursLabel: "Jam belajar",
      productive: "Produktif",
      recentTasks: "Tugas Terkini",
      pendingTasks: (n) => `${n} belum selesai`,
      noTasks: "Belum ada tugas",
      targetProgress: "Progress Target",
      studyHoursTarget: "Jam Belajar",
      tasksDoneTarget: "Tugas Selesai",
      productiveDays: "Hari Produktif",
      weekDays: ["Sen", "Sel", "Rab", "Kam", "Jum", "Sab", "Min"],
      calendarDays: ["M", "S", "R", "K", "J", "S", "M"],
    ...
    wrapped: {
      ...
      tagline: "Satu bulan lagi, terus naik. 🔥",
      intro: (month) => `Ini rekap ${month} kamu.`,
      bodyText: "Bulan yang luar biasa!\nKamu makin konsisten dan terus berkembang.",
      tasksDoneLabel: "Tugas selesai",
      focusTimeLabel: "Waktu fokus",
      bestStreakLabel: "Runtutan terbaik",
      closeBtn: "Tutup ✕",
      swipeHint: "Swipe atau klik kartu di belakang",
      tasksTag: "Tugas",
      focusTag: "Waktu Fokus",
      streakTag: "Runtutan",
      categoriesTag: "Top Kategori",
      nextMonthTag: "Bulan Depan",
      tasksDoneThisMonth: "selesai bulan ini",
      totalFocusThisMonth: "total fokus bulan ini",
      avgPerDay: "Rata-rata 1.5 jam per hari",
      distribution: "Distribusi",
      longestStreak: "Runtutan terpanjang",
      personalBest: "Personal best! Pertahankan 💪",
      checkinThisMonth: "Jejak produktif bulan ini",
      mostProductiveIn: "Kamu paling produktif di ",
      nextMonthDesc: (tasks) => `Kalau kamu jaga ritme ini, bulan depan kamu bisa capai ${tasks} tugas.`,
      targetTasks: "Target tugas",
      targetStreak: "Target runtutan",
      targetFocus: "Target fokus",
      taskUnit: "tugas",
      dayUnit: "hari",
      hourUnit: "jam",
      quotes: [
        "Selangkah kecil setiap hari.",
        "Konsistensi mengalahkan intensitas.",
        "Progress, bukan kesempurnaan.",
        "Jaga terus runtutan-mu.",
        "Kamu terus berkembang.",
        "Satu bulan lagi, satu kemenangan lagi.",
      ],
      notesUnit: "catatan",
      streakLabel: "hari runtutan",
    },
    ...
    todo: {
      ...
      reminderDone: "Pengingat selesai! Tetap semangat! 💪",
      pendingFilter: "Belum",
